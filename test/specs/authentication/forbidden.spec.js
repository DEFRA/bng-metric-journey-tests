...
test.describe('authentication', { tag: '@authentication' }, () => {
  ...
  test.describe('Forbidden page — page content', { tag: '@regression' }, () => {
    test('renders the access denied page with heading, body and return link', async ({
      forbiddenPage,
      page
    }) => {
    ...
    test('serves the access denied page with a forbidden status', async ({
      forbiddenPage,
      page
    }) => {
